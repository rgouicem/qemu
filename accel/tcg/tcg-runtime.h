...
DEF_HELPER_FLAGS_2(trace_tcg_st, TCG_CALL_NO_RWG, void, i64, env)
DEF_HELPER_FLAGS_2(trace_tcg_ld, TCG_CALL_NO_RWG, void, i64, env)
DEF_HELPER_FLAGS_1(trace_tcg_syscall, TCG_CALL_NO_RWG, void, env)
